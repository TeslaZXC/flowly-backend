...
export declare class GigaChat {
    ...
    stream_readable(payload: Chat | Record<string, any> | string): Promise<EventEmitter>;
    stream(payload: Chat | Record<string, any> | string): AsyncIterable<ChatCompletionChunk & WithXHeaders>;
