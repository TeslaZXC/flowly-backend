...
function getRequestConfig({ chat, accessToken }, isBrowser = false) {
...
export async function stream_chat(client, args, isBrowser = false) {
    let done = false;
    const pushQueue = [];
    const readQueue = [];
...
export async function stream_chat_readable(client, args, isBrowser = false) {
